...
import com.akl.templatemobile.components.DefaultSlideToUnlockColors
import com.akl.templatemobile.components.HintTexts
import com.akl.templatemobile.components.SlideOrientation
import com.akl.templatemobile.components.SlideToUnlock
import kotlinx.coroutines.delay
import org.jetbrains.compose.resources.painterResource
import org.jetbrains.compose.ui.tooling.preview.Preview
import templatemobile.composeapp.generated.resources.Res
import templatemobile.composeapp.generated.resources.dbz_logo

const val SIDE_CONTENT_DESCRIPTION = "Slide to unlock"
            ...
            Box(
                ...
                Image(
                    modifier = Modifier
                        ...
                        .size(40.dp),
                    painter = painterResource(Res.drawable.dbz_logo),
                    contentDescription = "Slide to subscribe",
                )
            }
        },

        hint = { slided, fraction, hintTexts, colors, paddings, _ ->
        ...
        thumb = { _, _, colors, size, _ ->
            ...
            Box(
                ...
                Icon(
                    ...
                    contentDescription = SIDE_CONTENT_DESCRIPTION,
                )
            }
        },
...
private fun SlideToUnlockStyle3() {
    ...
    SlideToUnlock(
        ...
        colors = colors,
        onSlideCompleted = { isSlided = true },
        thumb = { _, fraction, colors, size, _ ->
            Box(
                modifier = Modifier
                    .size(size)
...
private fun SlideToUnlockStyle5() {
    ...
    SlideToUnlock(
        ...
        hint = { _, fraction, hintTexts, colors, _, _ ->
