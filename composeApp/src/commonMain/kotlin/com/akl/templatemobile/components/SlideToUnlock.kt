...
import androidx.compose.ui.unit.dp
import com.akl.templatemobile.components.SlideToUnlockDefaults.ThumbSize
import com.akl.templatemobile.effects.RememberedEffect
    ...
    SlideToUnlockTrack(
        ...
        Box(
            modifier = Modifier.offset {
                when (orientation) {
                    SlideOrientation.Horizontal -> IntOffset(
